...
process.cumulantMB = cms.EDAnalyzer('QWCumuV3'
	...
	, rfpmineta = cms.untracked.double(-1.0)
	, rfpmaxeta = cms.untracked.double(1.0)
	, rfpminpt = cms.untracked.double(1.0)
	, rfpmaxpt = cms.untracked.double(3.0)
	, poimineta = cms.untracked.double(-1.0)
	, poimaxeta = cms.untracked.double(1.0)
	, poiminpt = cms.untracked.double(1.0)
	, poimaxpt = cms.untracked.double(3.0)
	, b2PartGap = cms.untracked.bool(True)
	, dEtaGap = cms.untracked.double(1.0)
...
process.load('PbPb_HIMB2_general_eff')

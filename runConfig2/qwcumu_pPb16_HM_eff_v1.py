...
process.mon120 = cms.Sequence(process.vectPhi120 + process.vectPt120 + process.vectEta120 + process.vectPhiW120 + process.vectPtW120 + process.vectEtaW120)
process.mon150 = cms.Sequence(process.vectPhi150 + process.vectPt150 + process.vectEta150 + process.vectPhiW150 + process.vectPtW150 + process.vectEtaW150)
process.mon185 = cms.Sequence(process.vectPhi185 + process.vectPt185 + process.vectEta185 + process.vectPhiW185 + process.vectPtW185 + process.vectEtaW185)
process.mon220 = cms.Sequence(process.vectPhi220 + process.vectPt220 + process.vectEta220 + process.vectPhiW220 + process.vectPtW220 + process.vectEtaW220)
process.mon250 = cms.Sequence(process.vectPhi250 + process.vectPt250 + process.vectEta250 + process.vectPhiW250 + process.vectPtW250 + process.vectEtaW250)
process.mon280 = cms.Sequence(process.vectPhi280 + process.vectPt280 + process.vectEta280 + process.vectPhiW280 + process.vectPtW280 + process.vectEtaW280)

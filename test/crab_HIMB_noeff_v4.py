...
config.General.requestName = 'HIMB3_cal_noeff_v14'
...
#
'''
config.General.requestName = 'HIMB3_cal_noeff_sysCalo_v14'
...
'''
config.General.requestName = 'HIMB3_cal_noeff_sysLoose_v14'
...
config.General.requestName = 'HIMB3_cal_noeff_sysVz1_v14'
...
config.General.requestName = 'HIMB3_cal_eff_v14'
...
'''
# MB2
config.General.requestName = 'HIMB2_cal_noeff_v14'
...
config.General.requestName = 'HIMB2_cal_noeff_sysTight_v14'
config.JobType.psetName = 'qwcumuv2_PbPb15_HIMB_rfp24_v2_sysTight.py'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
...
config.General.requestName = 'HIMB2_cal_noeff_sysLoose_v14'
config.JobType.psetName = 'qwcumuv2_PbPb15_HIMB_rfp24_v2_sysLoose.py'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
...
config.General.requestName = 'HIMB2_cal_eff_v14'
config.JobType.psetName = 'qwcumuv2_PbPb15_HIMB_rfp24_v2_sysEff.py'
config.JobType.inputFiles = ['PbPb_dijet_TT_5TeV_v2.root']
try:
        crabCommand('submit', config = config)
...
# MB4
config.General.requestName = 'HIMB4_cal_noeff_v14'

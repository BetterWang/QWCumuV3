...
process.cumulant100 = cms.EDAnalyzer('QWCumuV3'
	...
	, rfpmineta_ = cms.untracked.double(0.6)
	, rfpmaxeta_ = cms.untracked.double(1.2)
#	, bPhiEta_ = cms.untracked.bool(True)
	, bCentNoff_ = cms.untracked.bool(True)
	, poimineta_ = cms.untracked.double(0.6)
	, poimaxeta_ = cms.untracked.double(1.2)
	...
	, bFlipEta_ = cms.untracked.bool(True)
)

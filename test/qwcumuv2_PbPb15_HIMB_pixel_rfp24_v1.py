...
process.source = cms.Source("PoolSource",
	fileNames = cms.untracked.vstring("file:../../QWPCA/test/pixeltracking_1.root")
)
...
process.mb = cms.Path(process.hltMB*process.eventSelection*process.centralityBin*process.cumulantMB)

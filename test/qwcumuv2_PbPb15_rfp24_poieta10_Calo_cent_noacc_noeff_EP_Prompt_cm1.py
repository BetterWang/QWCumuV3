...
process.source = cms.Source("PoolSource",
        fileNames = cms.untracked.vstring("file:/afs/cern.ch/user/q/qwang/work/cleanroomRun2/CMSSW_7_5_7_patch1/Skim/FC577170-6C99-E511-9848-02163E014120.root")
)
...
process.hardprobe = cms.Path(process.centralityBin*process.cumulantMB)

...
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring("file:/afs/cern.ch/user/q/qwang/work/cleanroom2/CMSSW_5_3_20/test/skim/PAHighPt_RECO.root")
)
...
process.p100 = cms.Path(process.hltHM100*process.PAcollisionEventSelection*process.pileupVertexFilterCutGplus*process.cumulant100)
process.p130 = cms.Path(process.hltHM130*process.PAcollisionEventSelection*process.pileupVertexFilterCutGplus*process.cumulant130)
process.p160 = cms.Path(process.hltHM160*process.PAcollisionEventSelection*process.pileupVertexFilterCutGplus*process.cumulant160)
process.p190 = cms.Path(process.hltHM190*process.PAcollisionEventSelection*process.pileupVertexFilterCutGplus*process.cumulant190)
process.p220 = cms.Path(process.hltHM220*process.PAcollisionEventSelection*process.pileupVertexFilterCutGplus*process.cumulant220)

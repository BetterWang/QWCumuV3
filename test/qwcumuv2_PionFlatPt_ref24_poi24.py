...
#	, bPhiEta_ = cms.untracked.bool(True)
	...
	, Noffmin_ = cms.untracked.int32(120) # not used if bGen_ is true
	, Noffmax_ = cms.untracked.int32(150) # not used if bGen_ is true
...
process.AftBurner.bDoubleV2 = cms.untracked.int32(0)

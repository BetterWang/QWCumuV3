...
config.General.requestName = 'HIMB3_cal_noeff_v2'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumuv2_PbPb15_HIMB_rfp24_poieta10_Calo_cent_noacc_noeff_EP_Prompt_cm1.py'
...
# MB1
config.General.requestName = 'HIMB1_cal_noeff_v3'
...
# MB2
config.General.requestName = 'HIMB2_cal_noeff_v3'
...
# MB4
config.General.requestName = 'HIMB4_cal_noeff_v3'

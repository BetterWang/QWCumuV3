...
process.cumulant1420 = cms.EDAnalyzer('QWCumuV3'
	...
	, dzdzerror_ = cms.untracked.double(2.0)
	, d0d0error_ = cms.untracked.double(2.0)
...
process.hardprobe10_1420 = cms.Path(process.hltHP10_1420*process.centralityBin*process.centralityFilter10*process.cumulant1420)
process.hardprobe10_2026 = cms.Path(process.hltHP10_2026*process.centralityBin*process.centralityFilter10*process.cumulant2026)
process.hardprobe10_2635 = cms.Path(process.hltHP10_2635*process.centralityBin*process.centralityFilter10*process.cumulant2635)
process.hardprobe10_35   = cms.Path(process.hltHP10_35  *process.centralityBin*process.centralityFilter10*process.cumulant35)

process.hardprobe30_1420 = cms.Path(process.hltHP30_1420*process.centralityBin*process.centralityFilter30*process.cumulant1420)
process.hardprobe30_2026 = cms.Path(process.hltHP30_2026*process.centralityBin*process.centralityFilter30*process.cumulant2026)
process.hardprobe30_2635 = cms.Path(process.hltHP30_2635*process.centralityBin*process.centralityFilter30*process.cumulant2635)
process.hardprobe30_35   = cms.Path(process.hltHP30_35  *process.centralityBin*process.centralityFilter30*process.cumulant35)

process.hardprobe100_1420 = cms.Path(process.hltHP100_1420*process.centralityBin*process.centralityFilter100*process.cumulant1420)
process.hardprobe100_2026 = cms.Path(process.hltHP100_2026*process.centralityBin*process.centralityFilter100*process.cumulant2026)
process.hardprobe100_2635 = cms.Path(process.hltHP100_2635*process.centralityBin*process.centralityFilter100*process.cumulant2635)
process.hardprobe100_35   = cms.Path(process.hltHP100_35  *process.centralityBin*process.centralityFilter100*process.cumulant35)

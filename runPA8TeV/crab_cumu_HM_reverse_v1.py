...
config.General.requestName = 'PAHM0_cumu_eff_reverse_v5'
...
#
#config.General.requestName = 'PAHM1_cumu_eff_reverse_v5'
...
config.General.requestName = 'PAHM2_cumu_eff_reverse_v5'
config.JobType.psetName = 'qwcumu_pPb16_HM1_eff_v2.py'
config.JobType.inputFiles = ['Hijing_8TeV_MB_eff_v2.root']
try:
        crabCommand('submit', config = config)
...
#
#
#config.General.requestName = 'PAHM7_cumu_eff_reverse_v5'

...
config.General.requestName = 'XeXe1_CumuV3_eff_Cent_sysNarrow_v1'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumuV3_XeXe_ppReco_Cent_eff_sysNarrow_v1.py'
config.Data.inputDataset = '/HIMinimumBias1/XeXeRun2017-13Dec2017-v1/AOD'
config.JobType.inputFiles = ['XeXe_eff_narrow_table_94x_cent.root']
...
config.General.requestName = 'XeXe2_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe3_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe4_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe5_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe6_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe7_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe8_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe9_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe10_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe11_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe12_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe13_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe14_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe15_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe16_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe17_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe18_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe19_CumuV3_eff_Cent_sysNarrow_v1'
...
config.General.requestName = 'XeXe20_CumuV3_eff_Cent_sysNarrow_v1'

...
config.General.requestName = 'XeXe1_CumuV3_Hydjet_RECO_sysTight_v1'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumuV3_XeXe_Hydjet_RECO_Cent_eff_sysTight_v1.py'
config.Data.inputDataset = '/XeXeMinBias_5p44TeV-HydjetCymb5Ev8/HINXeXeFall17DR-94X_mc2017_realistic_ForXeXe_v7-v2/GEN-SIM-RECO'

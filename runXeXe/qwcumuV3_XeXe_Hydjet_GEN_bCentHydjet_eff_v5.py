...
#	fileNames = cms.untracked.vstring("root://xrootd.unl.edu//store/himc/HINXeXeFall17DR/XeXeMinBias_5p44TeV-HydjetCymb5Ev8/GEN-SIM-RECO/94X_mc2017_realistic_ForXeXe_v7-v2/40000/00261A37-470C-E811-A936-02163E01191C.root")
	fileNames = cms.untracked.vstring("/store/himc/HINXeXeFall17GS/XeXeMinBias_5p44TeV-HydjetCymb5Ev8/GEN-SIM/93X_mc2017_realistic_v3-v1/00000/00145C4D-26F6-E711-B698-3417EBE64BBE.root")
)
...
process.cumulantMB = cms.EDAnalyzer('QWCumuV3'
	...
	, centrality = cms.untracked.InputTag('centralityBin', 'Hydjet')
...
process.QWEvent = cms.EDProducer("QWGenEventProducer",
		...
		pdgId = cms.untracked.vint32(211, -211, 321, -321, 2212, -2212, 11, -11, 13, -13),
		)


# monitoring
process.histCent = cms.EDAnalyzer('QWHistAnalyzer',
		src = cms.untracked.InputTag("centralityBin", 'Hydjet'),

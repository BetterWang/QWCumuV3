...
#
#l = open('hydjet.flist').read().split()
#
...
process.source = cms.Source("PoolSource",
	fileNames = cms.untracked.vstring("/store/himc/HINXeXeFall17GS/XeXeMinBias_5p44TeV-HydjetCymb5Ev8/GEN-SIM/93X_mc2017_realistic_v3-v1/00000/506F8FC2-04F6-E711-AADE-1866DA890A68.root")
)

process.TFileService = cms.Service("TFileService",
	fileName = cms.string('hydjet_gen.root')
)
